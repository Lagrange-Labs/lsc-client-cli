...
CHAIN_TO_SUBSCRIBE= # rollup chain ID i.e. 10
...
subscribe_chain() {
    cast send $LAGRANGE_SERVICE_ADDR "subscribe(uint32)" $CHAIN_TO_SUBSCRIBE --private-key $OPERATOR_PRIVATE_KEY
